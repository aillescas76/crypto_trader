defmodule CriptoTrader.Strategy.Experiment.MaGatedRotationSmaGate13w20260314 do
  @moduledoc """
  Per-asset 13-week SMA gate + 4-week cross-sectional momentum rotation (1w rebalance).

  Hypothesis: A shorter 13-week SMA gate enables faster re-entry into recovery trends
  after bear markets. The 20-week gate (MaGatedRotation base) re-entered in March 2023;
  a 13-week gate would have allowed re-entry in January 2023, capturing ~2 extra months
  of the 2023 recovery. Expected to improve training PnL by capturing earlier recoveries.
  Risk: 13w gate may allow more false entries during 2025 choppy validation.

  Changes vs MaGatedRotation20260313 (base):
  - ma_period_weeks: 20 → 13 (shorter gate, faster re-entry in recoveries)
